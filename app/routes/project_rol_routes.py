...
@router.post("/project-roles", response_model=ProjectRol)
async def create_project_rol(project_rol: ProjectRol):
    return project_rol_controller.create_project_rol(project_rol)


@router.get("/project-roles/{project_rol_id}", response_model=ProjectRol)
async def get_project_rol(project_rol_id: int):
    return project_rol_controller.get_project_rol(project_rol_id)


@router.get("/project-roles", response_model=List[ProjectRol])
async def get_project_roles():
    return project_rol_controller.get_project_roles()


@router.put("/project-roles/{project_rol_id}", response_model=ProjectRol)
async def update_project_rol(project_rol_id: int, project_rol: ProjectRol):
